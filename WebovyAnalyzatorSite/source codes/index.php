        ...
        <?php
                ...
                */
                ...
                function vypocet_adres($oktet1, $oktet2, $oktet3, $oktet4, $prefix){
                        ...
                        complete_IP($barevny_string, "bity se kterými můžeme pracovat");

                        maska($prefix);

                        broadcast_adress($prefix, $oktet1, $oktet2, $oktet3, $oktet4);

                        hosts($oktet4, $IP_adres, $prefix);
                ...
                function maska($prefix){
                        ...
                        echo "<h1>maska v desítkové soustavě</h1>";
                ...
                function broadcast_adress($prefix, $oktet1, $oktet2, $oktet3, $oktet4){
                        ...
                        echo "<h1>Broadcast v desítkové soustavě</h1>";
                 ...
                 */
                function hosts($oktet4, $IP_adres, $prefix){
                        $comas = 0;
                        $substring = 0;
                        $last_octet = zjisteni_posledniho_oktetu($prefix);
                        $const = 254 - $last_octet;
                        do{
                ...
                function zjisteni_posledniho_oktetu($prefix){
                        $max_prefix = 32;
                        ...
                        return bindec($DEC_maska_sjednocena[3]);
                }
                ?>
